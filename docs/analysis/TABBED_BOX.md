...
The current implementation in `crates/gcodekit5-camtools/src/tabbed_box.rs` and `crates/gcodekit5-ui/ui_panels/tabbed_box_dialog.slint` has several critical issues and missing features compared to the reference implementation [TabbedBoxMaker](https://github.com/paulh-rnd/TabbedBoxMaker).
